...
export async function expandDiscoverySearchWithAi({
  ...
  try {
    ...
    const prompt = [
      ...
      "- Keep the student stage anchored. For starting_college students, broaden major/ethnicity/geography before broadening stage language.",
      "- For starting_college students, prefer incoming freshman, first-year college, and high school senior phrasing; avoid drifting to generic undergraduate/current college wording unless the evidence clearly supports it.",
      "- Broad-fit includes major+stage, ethnicity+stage, STEM+freshman, and state+same-stage scholarships.",
